function [] = crowding_model_filters_heatmap_larger()
...
num_RFs = 96; %divisible by 3
num_training_stims = 300; %divisible by 3
...
for iteration = 1:num_its
    ...
    training_stims = zeros(stim_size,stim_size,num_training_stims);
    ...
    for x_location = 10:2:stim_size-10
        for y_location = 10:2:stim_size-10
