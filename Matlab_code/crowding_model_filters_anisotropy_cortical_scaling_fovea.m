...
RF_horiz_size = 25; % was 50

RF_scaling_slope = .75;

num_RFs = 45; %divisible by 3
...
for iteration = 1:num_its
    ...
    RFs = corticalSample_fovea(num_RFs,this_mag);
    ...
    for RF_num = 1:num_RFs
        RF_ecc = sqrt((RFs(RF_num,1))^2 + RFs(RF_num,2)^2);
        horiz_size = (RF_horiz_size/2) + .7*RF_ecc/2;
        vert_size = (RF_vert_size/2) + .7*RF_ecc/2;
...
save(['C:/Users/Wes/Dropbox/Crowding_Model_Materials/RF_Size_35' num2str(i) '_final_' namepart 'fovea.mat'],'all_percent_correct','all_sparse_percent_correct');
        %'all_test2_sparse_percent_correct_leftright','all_test2_sparse_percent_correct_updown');
